...
const powerBillingPeriods = [
    {
        billingPeriodDate: "2026-08-14",
        totalBillingPaid: 423,
        tier: 2,
        meters: [
            {
                meterId: "1号表",
            ...
            {
                meterId: "2号表",
                currentReading: [10984],
                peopleCount: 1.5
            },
            {
                meterId: "3号表+5号表",
                currentReading: [9579, 8692],
                peopleCount: 1
            },
            {
                meterId: "4号表",
    ...
    },
    {
        ...
        meters: [
            ...
            {
                meterId: "2号表",
                currentReading: [10848],
                peopleCount: 1.5
            },
            {
                meterId: "3号表+5号表",
                currentReading: [9365, 8676],
                peopleCount: 1
            },
            {
                meterId: "4号表",
...

    {
        ...
        meters: [
            ...
            {
                meterId: "2号表",
                currentReading: [10762],
                peopleCount: 1.5
            },
            {
                meterId: "3号表+5号表",
                currentReading: [9198, 8644],
                peopleCount: 1
            },
            {
                meterId: "4号表",
...

    {
        ...
        meters: [
            ...
            {
                meterId: "2号表",
                currentReading: [10683],
                peopleCount: 2
            },
            {
                meterId: "3号表+5号表",
                currentReading: [9042, 8632],
                peopleCount: 1
            },
            {
                meterId: "4号表",
    ...
    },
    {
        ...
        meters: [
            ...
            {
                meterId: "2号表",
                currentReading: [10658],
                peopleCount: 2
            },
            {
                meterId: "3号表+5号表",
                currentReading: [8953, 8624],
                peopleCount: 1
            },
            {
                meterId: "4号表",
